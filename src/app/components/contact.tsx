const ContactPage =()=>{
    return(
        <div id="contact">
            <section className="text-gray-600 body-font relative bg-teal-100">
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-2xl overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      <iframe
        width="100%"
        height="100%"
      ...
      <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <p className="leading-relaxed">0307-2184255</p>
        </div>
      </div>
    </div>
    <div className="lg:w-1/3 md:w-1/2  flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 bg-teal-100">
      <h2 className="title-font sm:text-4xl text-6xl  mb-4 font-bold text-gray-900">
        Contact
      </h2>
      ...
      <button className="text-white bg-teal-600 border-0 py-2 px-6 focus:outline-none hover:bg-teal-800 rounded text-lg">
        Send message
      </button>
